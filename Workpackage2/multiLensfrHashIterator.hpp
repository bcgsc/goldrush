 ...
 * HashFunction.hpp
 *
 * 	Created to get around templating issues revolving ntHashIterator and sfrHashIterator
 *
 *
...
class multiLensfrHashIterator
{
  public:
	...
	multiLensfrHashIterator(const std::string& seq, const std::vector<std::string>& seedVec):
